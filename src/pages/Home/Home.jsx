                      ...
                      <div className="table-body">
                        ...
                        <div className="table-item ng-star-inserted">
                          <div className="teamlist-info">
                            ...
                            <h3 className="team-title">
                              ...
                              <p className="ng-star-inserted">
                                <span className="team-name">mi cape town</span>
                                <img
                                  alt="Playing"
                                  src="https://ss.manage63.com/bmk-wl/commonAssets/batting-icon.svg"
                                  className="ng-star-inserted"
                        ...
                        <div className="table-item ng-star-inserted">
                          <div className="teamlist-info">
                            ...
                            <h3 className="team-title">
                              <p className="ng-star-inserted">
                                <span className="team-name">sydney sixers</span>
                              </p>
                              <p className="ng-star-inserted">
                                <span className="team-name">
                                  hobart hurricanes
                      ...
                      <div className="table-body">
                        <div className="table-item ng-star-inserted">
                          <div className="teamlist-info">
                            ...
                            <h3 className="team-title">
                              <p className="ng-star-inserted">
                                <span className="team-name">como</span>
                              </p>
                              <p className="ng-star-inserted">
                                <span className="team-name">bologna</span>
                              </p>
                              <p className="ng-star-inserted">
                        ...
                        <div className="table-item ng-star-inserted">
                          <div className="teamlist-info">
                            ...
                            <h3 className="team-title">
                              <p className="ng-star-inserted">
                                <span className="team-name">freiburg</span>
                              </p>
                              <p className="ng-star-inserted">
                                <span className="team-name">hamburger sv</span>
                              </p>
                              <p className="ng-star-inserted">
                                <span className="team-name">Draw</span>
                              </p>
                        ...
                        <div className="table-item ng-star-inserted">
                          <div className="teamlist-info">
                            ...
                            <h3 className="team-title">
                              <p className="ng-star-inserted">
                                <span className="team-name">fc heidenheim</span>
                              </p>
                              <p className="ng-star-inserted">
                                <span className="team-name">fc koln</span>
                              </p>
                              <p className="ng-star-inserted">
                                <span className="team-name">Draw</span>
                              </p>
                        ...
                        <div className="table-item ng-star-inserted">
                          <div className="teamlist-info">
                            ...
                            <h3 className="team-title">
                              <p className="ng-star-inserted">
                                <span className="team-name">unions berlin</span>
                              </p>
                              <p className="ng-star-inserted">
                                <span className="team-name">mainz</span>
                              </p>
                              <p className="ng-star-inserted">
                                <span className="team-name">Draw</span>
                              </p>
                        ...
                        <div className="table-item ng-star-inserted">
                          <div className="teamlist-info">
                            ...
                            <h3 className="team-title">
                              <p className="ng-star-inserted">
                                <span className="team-name">villarreal</span>
                              </p>
                              <p className="ng-star-inserted">
                                <span className="team-name">alaves</span>
                              </p>
                              <p className="ng-star-inserted">
                                <span className="team-name">Draw</span>
                              </p>
                      ...
                      <div className="table-body">
                        <div className="table-item ng-star-inserted">
                          <div className="teamlist-info">
                            ...
                            <h3 className="team-title">
                              <p className="ng-star-inserted">
                                <span className="team-name">kopriva</span>
                              </p>
                              <p className="ng-star-inserted">
                                <span className="team-name">hug gaston</span>
                              </p>
                            </h3>
                          </div>
                          <div className="flex-row-right rt-wrap">
                        ...
                        <div className="table-item ng-star-inserted">
                          <div className="teamlist-info">
                            ...
                            <h3 className="team-title">
                              <p className="ng-star-inserted">
                                <span className="team-name">spizzirri</span>
                              </p>
                              <p className="ng-star-inserted">
                                <span className="team-name">
                                  manuel cerundolo
                        ...
                        <div className="table-item ng-star-inserted">
                          <div className="teamlist-info">
                            ...
                            <h3 className="team-title">
                              <p className="ng-star-inserted">
                                <span className="team-name">em nava</span>
                              </p>
                              <p className="ng-star-inserted">
                                <span className="team-name">struff</span>
                              </p>
                            </h3>
                          </div>
                          <div className="flex-row-right rt-wrap">
                        ...
                        <div className="table-item ng-star-inserted">
                          <div className="teamlist-info">
                            ...
                            <h3 className="team-title">
                              <p className="ng-star-inserted">
                                <span className="team-name">ma bellucci</span>
                              </p>
                              <p className="ng-star-inserted">
                                <span className="team-name">ha medjedovic</span>
                              </p>
                            </h3>
                          </div>
                          <div className="flex-row-right rt-wrap">
                        ...
                        <div className="table-item ng-star-inserted">
                          <div className="teamlist-info">
                            ...
                            <h3 className="team-title">
                              <p className="ng-star-inserted">
                                <span className="team-name">al shevchenko</span>
                              </p>
                              <p className="ng-star-inserted">
                                <span className="team-name">taberner</span>
                              </p>
                            </h3>
                          </div>
                          <div className="flex-row-right rt-wrap">
                ...
                <div className="game-type-list ng-star-inserted">
                  <ul className="sRowScroll">
                    ...
                    <li className="ng-star-inserted">
                      ...
                      <div className="game-detail">
                        <p className="company-type">Smartsoft Gaming</p>
                    ...
                    <li className="ng-star-inserted">
                      ...
                      <div className="game-detail">
                        <p className="company-type">Evoplay Entertainment</p>
                ...
                <div className="game-type-list ng-star-inserted">
                  <ul className="sRowScroll">
                    <li className="ng-star-inserted">
                      ...
                      <div className="game-detail">
                        <p className="company-type">Evolution Gaming</p>
                    ...
                    <li className="ng-star-inserted">
                      ...
                      <div className="game-detail">
                        <p className="company-type">Microgaming Live</p>
                        <p className="game-name">Cash Wheel Carnival</p>
                      </div>
                    </li>
                    <li className="ng-star-inserted">
                      <p className="total-players">
                    ...
                    <li className="ng-star-inserted">
                      ...
                      <div className="game-detail">
                        <p className="company-type">Evolution Gaming</p>
                        <p className="game-name">Extra Chilli Epic Spins</p>
                      </div>
                    </li>
                    <li className="ng-star-inserted">
                      <p className="total-players">
                ...
                <div className="game-type-list ng-star-inserted">
                  <ul className="sRowScroll">
                    <li className="ng-star-inserted">
                      ...
                      <div className="game-detail">
                        <p className="company-type">Evolution Gaming</p>
                        <p className="game-name">Hindi Lightning Roulette</p>
                      </div>
                    </li>
                    <li className="ng-star-inserted">
                      <a className="active">
                      ...
                      <div className="game-detail">
                        <p className="company-type">Evolution Gaming</p>
                        <p className="game-name">Gold Vault Roulette</p>
                      </div>
                    </li>
                    <li className="ng-star-inserted">
                      <a className="active">
                    ...
                    <li className="ng-star-inserted">
                      ...
                      <div className="game-detail">
                        <p className="company-type">Evolution Gaming</p>
                        <p className="game-name">Lightning Roulette</p>
                      </div>
                    </li>
                    <li className="ng-star-inserted">
                      <a className="active">
                      ...
                      <div className="game-detail">
                        <p className="company-type">Evolution Gaming</p>
                        <p className="game-name">Double Ball Roulette</p>
                      </div>
                    </li>
                    <li className="ng-star-inserted">
                      <a className="active">
                    ...
                    <li className="ng-star-inserted">
                      ...
                      <div className="game-detail">
                        <p className="company-type">Evolution Gaming</p>
                        <p className="game-name">Hindi Speed Baccarat A</p>
                      </div>
                    </li>
                    <li className="ng-star-inserted">
                      <a className="active">
                    ...
                    <li className="ng-star-inserted">
                      ...
                      <div className="game-detail">
                        ...
                        <p className="coins-limit ng-star-inserted">₹1 - 20K</p>
                      </div>
                    </li>
                  </ul>
                </div>
