    ...
    <div className="page-body">
      <div className="rules-page-wrap">
        ...
        <div className="content-setting">
          ...
          <p>1) CHEAT RULES: -</p>
          <p>
            1.1) In Betfair &amp; Fancy markets, If anyone is suspected using
            ground commentary or ground line or courtsiding(being in ground
            while betting), company will void all winning bets(without providing
            any proof). This is a zero tolerance policy and no arguments will be
          ...
          <p>2.1) Cricket: We will follow Betfair result.</p>
          <p>2.2) Soccer: We will follow Betfair result.</p>
          <p>2.3) Tennis: We will follow Betfair result.</p>
          <p>
            2.4) IF Any Client Found Hedging Or Doing Manipulation in Any Match
            Odds, then company has the right to Void the Bets.
          </p>
          <p>
            2.5) If Exchange resettle any bets or Markets due to wrong Result
            Declaration or any other reason &amp; if the Player has lost Money
            or If Player gets Negative Balance, In this case Company will do the
            Settlement from Agent for the same, all decision will be Full And
            Final, No Arguments will be listened.
          </p>
          <p>
            2.6) Company reserves the right to void any bets (only winning bets)
          ...
          <p>
            3.1) Due to any reason any team will be getting advantage or
            disadvantage we are not concerned.
          </p>
          <p>
            3.2) Wrong team selection by our mistake all back and lays bets will
            be deleted.
          </p>
          <p>3.3) wrong rate bets also voided.</p>
          <p>
            3.4) If Exchange resettle any bets or Markets due to wrong Result
            Declaration or any other reason &amp; if the Player has lost Money
            or If Player gets Negative Balance, In this case Company will do the
            Settlement from Agent for the same, all decision will be Full And
            Final, No Arguments will be listened.
          ...
          <p>
            3.5) Company reserves the right to void any bets (only winning bets)
            of any event at any point of the match if the company believes there
            is any cheating/wrong doing in that particular event by the players
            (either batsman/bowler).
          </p>
          <p>
            3.6) If both the teams score same runs in 4,6,10,15 overs &amp; 25
            Balls Bookmaker the team that first bated will be declared as the
            winner.
          </p>
          <p>4) FANCY:-</p>
          <p>
            4.1) Advance fancy: - Advance Session, Player Runs and all Fancy
          ...
          <p>
            4.2) All advance fancy bets market will be suspended 60 mins prior
            to match and will be settled.
          </p>
          <p>4.3) Advance session and Lambi 1st inning valid only.</p>
          <p>
            4.4) Total match playing over adv: - We Will Settle this Market
            after Whole Match gets Completed.
          </p>
          <p>
            4.5) Criteria: - We Will Count Only Round- Off Over For Both the
          ...
          <p>
            4.6) In Case of Rain or if Over gets Reduced then this Market will
            get Voided.
          </p>
          <p>
            4.7) 3 Wkt or more by bowler in match adv:- We Will Settle this
            Market after Whole Match gets Completed.
          </p>
          <p>
            4.8) Once all session/fancy bets are completed and settled there
            will be no reversal even if the Match is Tied or is Abandoned.
          </p>
          <p>
            4.9) Under the rules of Session/Fancy Bets if a market gets
          ...
          <p>
            4.10) Incomplete Session/Fancy Bet will be cancelled but Complete
            Session will be settled.
          </p>
          <p>
            4.11) In the case of Running Match getting Cancelled/ No Result/
          ...
          <p>
            4.12) If a player gets Retired Hurt and one ball is completed after
            you place your bets then all the betting till then is and will
            remain valid.
          </p>
          <p>
            4.13) Should a Technical Glitch in Software occur, we will not be
            held responsible for any losses.
          </p>
          <p>
            4.14) Should there be a power failure or a problem with the Internet
            connection at our end and session/fancy market does not get
            suspended then our decision on the outcome is final.
          </p>
          <p>
            4.15) All decisions relating to settlement of wrong market being
            offered will be taken by management. Management will consider all
            actual facts and decision taken will be full in final.
          </p>
          <p>
            4.16) Any bets which are deemed of being suspicious, including bets
          ...
          <p>
            4.17) Any sort of cheating bet, any sort of Matching (Passing of
          ...
          <p>
            4.18) If any case wrong rate has been given in fancy,that particular
            bets will be cancelled (Wrong Commentary).
          </p>
          <p>
            4.19) In case customer make bets in wrong fancy we are not liable to
            delete, no changes will be made and bets will be considered as
            confirm bet.
          </p>
          <p>
            4.20) any query regarding result or rate has to be contacted within
            7 days from the event, query after 7 days from the event will not be
            considered as valid.
          </p>
          <p>
            4.21) The Rules Which we have added Regarding
            Cheating/Hedging/manipulation of Odds are ONLY for the Ones with
            Wrong Intensions Not for Genuine Clients.
          </p>
          <p>
            4.22) Penalty Runs - Any Penalty Runs Awarded in the Match (In Any
            Running Fancy or ADV Fancy) Will Not be Counted While Settling in
            our Exchange.
          </p>
          <p>
            4.23) Player Boundaries Fancy:- We will only consider Direct Fours
            and Sixes hit by BAT.
          </p>
          <p>
            4.24) Bowler run session rule:- If Bowler Bowl 1.1 over,then
          ...
          <p>
            4.25) Any cricket event which is being held behind closed doors in
          ...
          <p>
            4.26) Company reserves the right to suspend/void any id/bets if the
          ...
          <p>
            4.27) Odd-even rules:- Incomplete games will be deleted. Over
            reduced or abandoned all bets will be deleted.
          </p>
          <p>4.28) In any circumstances company decision will be final.</p>
          <p>
            4.29) If Users Found Betting In Group&apos;s then We Will Void
            &quot;Only The Winning Bets of the Users&quot; and Company Decision
            Will be Full and Final.
          </p>
          <p>
            4.30) If Exchange resettle any bets or Markets due to wrong Result
            Declaration or any other reason &amp; if the Player has lost Money
            or If Player gets Negative Balance, In this case Company will do the
            Settlement from Agent for the same, all decision will be Full And
            Final, No Arguments will be listened.
          ...
          <p>
            4.31) Company reserves the right to void any bets (only winning
          ...
          <p>5) IPL RULES:-</p>
          <p>
            5.1) If Over Reduced in Match, we will not count the actual scores
            of the Over Reduced Matches instead we will count the Market’s
            Average Scores.
          </p>
          <p>
            5.2) If Match is Abandoned, we will not count the actual scores of
          ...
          <p>
            5.3) Total Fours: - Average 26 Fours will be given if the match is
            abandoned or over reduced.
          </p>
          <p>
            5.4) Total Sixes: - Average 13 Sixes will be given if the match is
            abandoned or over reduced.
          </p>
          <p>
            5.5) Total Wide: - Average 8 Wide’s will be given if the match is
            abandoned or over reduced.
          </p>
          <p>
            5.6) Total Extras: - Average 14 Extras will be given if the match is
            abandoned or over reduced.
          </p>
          <p>
            5.7) Total No Ball: - Average 1 No Ball will be given if the match
            is abandoned or over reduced.
          </p>
          <p>
            5.8) Total Duck: - Average 1 Duck will be given if the match is
            abandoned or over reduced.
          </p>
          <p>
            5.9) Total Fifties: - Average 2 Fifties will be given if the match
            is abandoned or over reduced.
          </p>
          <p>
            5.10) Total Century: -Average 0 Century will be given if the match
            is abandoned or over reduced.
          </p>
          <p>
            5.11) Total Run Out: - Average 1 Run Out will be given if the match
            is abandoned or over reduced.
          </p>
          <p>
            5.12) Total Caught out: - Average 8 Caught Out will be given if the
            match is abandoned or over reduced.
          </p>
          <p>
            5.13) Total Maiden Over: - Average 0 Maiden Over will be given if
            the match is abandoned or over reduced.
          </p>
          <p>
            5.14) Total LBW: - Average 1 LBW will be given if the match is
            abandoned or over reduced.
          </p>
          <p>
            5.15) Total Bowled: - Average 2 Bowled will be given if the match is
            abandoned or over reduced.
          </p>
          <p>
            5.16) Total Match 30 ADV: - If a player reached 50 means, Not
            considered in this Event.
          </p>
          <p>
            5.17) Total Match 50 ADV: - If a player reached 100 means, Not
            considered in this Event.
          </p>
          <p>
            5.18) In case IPL Matches Gets Stopped or Interrupted Due to
            &quot;COVID-19&quot; or Any &quot;ACT OF GOD&quot; Reasons, under 45
            Matches then All IPL 2021 Tournament Fancy Markets will be Voided,
            but if 45 or Above Matches are Being Played then we will Settle all
            the Fancy Markets and Also If there are NON-Played Matches Above 45
            then we will settle the markets as per our Markets Average.
          </p>
          <p>
            5.19) If IPL 2021 gets stopped due to “Covid-19” or Any “Act of God”
          ...
          <p>
            5.20) Middle session and Session is not completed due to Innings
            ...
            over counted for 135 over session from next team Innings and One
            over session and Only over session is not completed due to innings
            declared so that Particular over session bets will be deleted and
            all out considered as valid for ex:- In case of Innings declared In
            131.5th over so 132 over will be deleted and if all out then 132
            over and Only 132 over will be Valid.
          </p>
          <p>6) Casino RULES:-</p>
          <p>
            6.1) If Company voided any bet due to wrong rate or technical issue
          ...
          <p>7) Color Bets</p>
          <p>
            7.1) Any kind of market color bets shall be voided and all available
            balance shall be confesticated for placing bets with wrong
            intentions on our system
          </p>
          <p>
            7.2) Desicion of whether it’s a color bet or not is 100% of the
            company and no disputes or explanation or arguments shall be
